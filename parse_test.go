...
func TestParseHexColor(t *testing.T) {
	var p = map[string]color.Color{
		...
		"#001": color.RGBA{0, 0, 17, 255},
		"#010": color.RGBA{0, 17, 0, 255},
		"#100": color.RGBA{17, 0, 0, 255},
		"#112": color.RGBA{17, 17, 34, 255},
		"#00f": color.RGBA{0, 0, 255, 255},

		"#000000": color.RGBA{0, 0, 0, 255},
		"#000001": color.RGBA{0, 0, 1, 255},
		"#000010": color.RGBA{0, 0, 16, 255},
		"#000011": color.RGBA{0, 0, 17, 255},
		"#000100": color.RGBA{0, 1, 0, 255},
		"#001000": color.RGBA{0, 16, 0, 255},
		"#001100": color.RGBA{0, 17, 0, 255},

		"":          Default,
		"1":         Default,
		"12":        Default,
		"123":       color.RGBA{0x11, 0x22, 0x33, 0xff},
		"1234":      color.RGBA{0x11, 0x22, 0x33, 0x44},
		"12345":     Default,
		"123456":    color.RGBA{0x12, 0x34, 0x56, 0xff},
		"1234567":   Default,
		"12345678":  color.RGBA{0x12, 0x34, 0x56, 0x78},
		"123456789": Default,
		...
		"#XX1234": color.RGBA{0x00, 0x12, 0x34, 0xff},

		"0F0E0D":   color.RGBA{15, 14, 13, 255},
		"#ffffff":  color.RGBA{255, 255, 255, 255},
		"#CBE896":  color.RGBA{203, 232, 150, 255},
		"#FFFFFC":  color.RGBA{255, 255, 252, 255},
		"BEB7A4":   color.RGBA{190, 183, 164, 255},
		"FF7F11":   color.RGBA{255, 127, 17, 255},
		"#FF1B1C":  color.RGBA{255, 27, 28, 255},
		"aBcDE012": color.RGBA{0xab, 0xcd, 0xe0, 0x12},
	}
